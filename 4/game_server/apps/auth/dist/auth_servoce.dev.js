...
service_manager.register_service(2, auth); //数据操作

var mysql_center = require("../../database/mysql_center.js");

var game_config = require('../gateway/game_config.js');

mysql_center.connect("127.0.0.1", 3306, "user", "root", "sanzhixiong"); //end
//redis相关操作
