...
netbus.start_ws_server(center.host, center.port, false);

service_manager.register_service(Stype.Auth, auth_service);


// 连接中心数据库
var center_mysql_config = game_config.databases.center_database;
...
// 连接中心服务器的redis
var center_redis_config = game_config.databases.center_redis;
